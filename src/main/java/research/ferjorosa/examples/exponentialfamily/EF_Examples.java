package eu.amidst.core.examples.ferjorosa;
...
public class EF_Examples {
    ...
    public static void sprinklerOneObservedVar(){
        ...
        DataStream<DataInstance> data = DataStreamLoader.open("datasets/dataWeka/sprinklerData300_oneVar.arff");
    ...
    public static void sprinklerMaximumLikelihood(){
        ...
        DataStream<DataInstance> data = DataStreamLoader.open("datasets/dataWeka/sprinklerData300.arff");
    ...
    //We can open the data stream using the static class DataStreamLoader
        DataStream<DataInstance> data = DataStreamLoader.open("datasets/dataWeka/spinklerData300.arff");
