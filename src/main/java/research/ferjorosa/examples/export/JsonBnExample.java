package research.ferjorosa.examples.export;
...
import research.ferjorosa.core.util.exportBN.BayesianNetworkLocalExporter;
import research.ferjorosa.core.util.exportBN.format.ConvertBN;
