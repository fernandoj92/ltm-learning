...
*/
        ...
        DataStream<DataInstance> data3 = DataStreamLoader.open("datasets/ferjorosaData/Alarm_train.arff");
        ...
        DataStream<DataInstance> data4 = DataStreamLoader.open("datasets/ferjorosaData/Alarm_train.arff");
//        LTM naiveBayesModel = buildNBmodel(data4);
    ...
    private static LTM buildZhangLTM(DataOnMemory<DataInstance> batch){
        ...
        LatentVariable variable338 = new LatentVariable(
                variables.newMultinomialVariable("variable338", Arrays.asList(v338states)),0);
        ...
        LatentVariable variable29 = new LatentVariable(
                variables.newMultinomialVariable("variable29", Arrays.asList(v29states)),1);
        ...
        LatentVariable variable388 = new LatentVariable(
                variables.newMultinomialVariable("variable388", Arrays.asList(v388states)),2);
        ...
        LatentVariable variable386 = new LatentVariable(
                variables.newMultinomialVariable("variable386", Arrays.asList(v386states)),3);
        ...
        LatentVariable variable392 = new LatentVariable(
                variables.newMultinomialVariable("variable392", Arrays.asList(v392states)),4);
        ...
        LatentVariable variable391 = new LatentVariable(
                variables.newMultinomialVariable("variable391", Arrays.asList(v391states)),5);
        ...
        LatentVariable variable51 = new LatentVariable(
                variables.newMultinomialVariable("variable51", Arrays.asList(v51states)),6);
        ...
        LatentVariable variable73 = new LatentVariable(
                variables.newMultinomialVariable("variable73", Arrays.asList(v73states)),7);
        ...
        LatentVariable variable387 = new LatentVariable(
                variables.newMultinomialVariable("variable387", Arrays.asList(v387states)),8);
        ...
        LatentVariable variable389 = new LatentVariable(
                variables.newMultinomialVariable("variable389", Arrays.asList(v389states)),9);
        ...
        LatentVariable variable390 = new LatentVariable(
                variables.newMultinomialVariable("variable390", Arrays.asList(v390states)),10);
        ...
        LatentVariable variable46 = new LatentVariable(
                variables.newMultinomialVariable("variable46", Arrays.asList(v46states)),11);
